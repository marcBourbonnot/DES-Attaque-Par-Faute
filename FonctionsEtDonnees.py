...
#  Desc : repertoire de toutes les fonctions et les donnees necessaires au calcul du des / K16 / K

#  Donnees necessaires pour le calcul du DES :
#  IP :
...
#  Fonction permettant d'effectuer une rotation circulaire sur un tableau
def shift(tab, n):
    return tab[n:] + tab[:n]
